...
const pageConfig: PageConfig = {
  ...
  links: [
    { link: 'https://github.com/777xigua777', label: 'GitHub' },
    { link: 'https://nav.nav7890.de5.net/', label: '导航' },
  ],
}
...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    },
    {
      ...
      method: 'HEAD',
      target: 'https://cloudflare-imgbed-da2.pages.dev/',
      statusPageLink: 'https://cloudflare-imgbed-da2.pages.dev/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    ...
    },
    {
      ...
      name: 'moonTV',
      method: 'HEAD',
      target: 'https://6ab293b0.tv-awe.pages.dev/',
      statusPageLink: 'https://6ab293b0.tv-awe.pages.dev/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'LibreTV',
      method: 'HEAD',
      target: 'https://libretv-9ss.pages.dev/',
      statusPageLink: 'https://libretv-9ss.pages.dev/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'NodeCrypt',
      method: 'HEAD',
      target: 'https://nodecrypt.c7890c.workers.dev/',
      statusPageLink: 'https://nodecrypt.c7890c.workers.dev/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'SSL',
      method: 'HEAD',
      target: 'https://ssl.c7890c.workers.dev/',
      statusPageLink: 'https://ssl.c7890c.workers.dev/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    ...
    },
    {
      ...
      method: 'HEAD',
      target: 'https://ip-geoaddress-generator-czm.pages.dev/',
      statusPageLink: 'https://ip-geoaddress-generator-czm.pages.dev/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'qwe1',
      method: 'HEAD',
      target: 'https://qwe-6rc.pages.dev/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'qwe2',
      method: 'GET',
      target: 'https://nirvana1.dpdns.org/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'qwe3',
      method: 'HEAD',
      target: 'https://asd-76i.pages.dev/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
