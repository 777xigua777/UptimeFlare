...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    {      
      id: 'yolo-model-inspector',      
      name: 'yolo-model-inspector(不支持国内)',      
      method: 'GET',      
      target: 'https://huggingface.co/spaces/777xigua777/yolo-model-inspector',      
      statusPageLink: 'https://huggingface.co/spaces/777xigua777/yolo-model-inspector',      
      hideLatencyChart: false,      
      expectedCodes: [200],      
      timeout: 10000,    
},
